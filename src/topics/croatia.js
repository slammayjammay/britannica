export default {
	...
	intro: {
		...
		id: 'croatia',
		writtenBy: ['Liz David-Barrett', 'John R. Lampe', 'Dijana Pleština', 'C.W. Bracewell'],
		lastUpdated: 'Jul 17, 2018',
		paragraphs: [
	...
	sections: [
		{
			...
			sections: [
				...
				{
					header: 'Plant and animal life',
					id: 'plant-animal-life',
					paragraphs: [
		...
		},
		{
			...
			sections: [
				{
					header: 'Ethnic groups and religions',
					id: 'ethnic-groups',
					paragraphs: [
		...
		},
		{
			...
			sections: [
				...
				{
					header: 'Finance, trade, and services',
					id: 'finance-trade-services',
					paragraphs: [
				...
				{
					header: 'Transportation and telecommunications',
					id: 'transportation-telecommunications',
					paragraphs: [
		...
		{
			header: 'Government And Society',
			id: 'government-society',
			paragraphs: [],
			sections: [
				{
					header: 'Constitutional framework',
				...
				{
					header: 'Health, welfare, and housing',
					id: 'health-welfare-housing',
					paragraphs: [
		...
		{
			header: 'Cultural Life',
			id: 'cultural-life',
			paragraphs: [],
			sections: [
				{
					header: 'Cultural milieu',
					id: 'cultural-milieu',
					paragraphs: [
				...
				{
					header: 'Daily life and social customs',
					id: 'daily-life-social-customs',
					paragraphs: [
